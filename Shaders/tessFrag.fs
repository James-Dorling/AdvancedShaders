...
{    
	...
	vec3	specular = specFactor * light.specular * vec3(texture(texture_specular1, fs_in.gUV)); //Set the specular light via the specular factor, the light.specular value and the texture
